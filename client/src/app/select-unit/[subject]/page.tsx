  ...
  return (
    <div className="min-h-screen relative text-slate-800 dark:text-slate-200 font-sans pb-32">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-1.5 md:gap-6">
          ...
          <div className="flex items-center gap-3">
            <button 
              ...
              className="w-10 h-10 md:w-12 md:h-12 flex items-center justify-center bg-white/80 hover:bg-white border border-slate-200 hover:border-brand-400 text-slate-600 hover:text-brand-600 active:bg-brand-100 active:scale-95 transition-all duration-200 rounded-xl shrink-0 group shadow-sm"
            >
      ...
      <footer className="text-center py-12 text-slate-400 text-sm font-medium">
        <p>© 2026 DugiGo Smart License Solution (v2.0.3)</p>
